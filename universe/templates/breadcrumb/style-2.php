...
*	Version: 1.0
*
*	Positions: descriptions|textarea|<p>Universe is clean & modern design theme</p><p>It is a good way to get inspiration for your projects<p/>
*
...
<div id="breadcrumb" class="page_title3" style="<?php echo universe::esc_js($breadcrumb_bg); ?>">
	<div class="container">
