<?php
class universe_options_boolean extends universe_options{	
	...
	*/
	function __construct($field = array(), $value ='', $parent){
		...
		$this->field = $field;
		$this->value = $value;
		$this->field['options'] = array('yes' => 'Yes','no' => 'No');
		//$this->render();
	...
	*/
	function enqueue(){
		...
		wp_enqueue_script(
			...
			universe_options_URL.'fields/button_set/field_button_set.js', 
