<?php
class universe_options_google_webfonts extends universe_options{
	...
	*/
	function render(){
		...
		echo '<p class="description" style="color:red;">'. esc_html__('The fonts provided below are free to use custom fonts from the','universe') .' <a href="http://www.'.'google.com/webfonts'.'" target="_blank">'. esc_html__('Google Web Fonts directory','universe') .'</a>.<br/>Please <a href="http://www.'.'google.com/webfonts'.'" target="_blank">browse the directory</a>'. esc_html__(' to preview a font, then select your choice below.', 'universe') .'</p>';
