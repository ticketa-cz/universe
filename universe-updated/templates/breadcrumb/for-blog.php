...
*	Version: 1.0
*   Positions: descriptions|textarea|Blog Post
		...
		<div class="container">
			<div class="title">
				<h1 class="font-sans">
					...
					if (!empty($atts['descriptions'])) {
						echo wp_kses_post( $atts['descriptions'] );
					}else if(!empty($universe->cfg['blog_breadcrumb']) && !empty($universe->cfg['blog_breadcrumb']['heading'])) {
						echo esc_html($universe->cfg['blog_breadcrumb']['heading']);
					}else{
						universe_title();
					} 
				...
				<?php
					...
					if (empty($atts['descriptions']) && !empty($universe->cfg['blog_breadcrumb']) && !empty($universe->cfg['blog_breadcrumb']['heading_sub'])) {
						echo '<p><span>';
						echo str_replace("\n", "</span><br /><span>", esc_html($universe->cfg['blog_breadcrumb']['heading_sub']));
						echo '</span></p>';
					}
