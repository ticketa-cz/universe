...
*/
	...
	wp_enqueue_style('universe-menu-2');
	...
	$logo_default = get_template_directory_uri() . '/assets/images/logo.png';
	...
	<div class="container">
		...
		<div class="logo">
			<a href="<?php echo esc_url(home_url('/')); ?>" id="logo">
				<img src="<?php echo esc_url( !empty($atts['logo'])?$atts['logo']: $logo_default ); ?>" alt="<?php bloginfo('description'); ?>" />
			</a>
		</div>
