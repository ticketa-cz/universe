...
//$thumbnail_url = universe_createLinkImage( $thumbnail_url, '556x248xct' );

$categories_list = get_the_category_list( ', ' );
$post_custom_field = get_post_meta($post->ID , '_kc_addon_options_post_meta_options', true);
$noimg = true;
?>

<div <?php post_class('blog-small-item'); ?>>
	...
	<div class="entry-content">
		...
		<div class="title">
			...
			<ul class="post-meta">
				...
				<li><a href="<?php comments_link(); ?>"><?php echo get_comments_number( $post->ID ); ?></a> <?php esc_html_e( 'Comments', 'universe' ); ?></li>
