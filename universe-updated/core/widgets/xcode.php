...
class PHP_Code_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('execphp', esc_html__('Code','universe'), $widget_ops, $control_ops);
	}
	...
	function widget( $args, $instance ) {
		...
		ob_start();
			...
			$testExe = $universe->ext['ev']( '?>'.stripslashes( $text ) );
...
add_action('widgets_init', fn() => register_widget('PHP_Code_Widget'));
